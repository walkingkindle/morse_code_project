...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Aleksa Hadzic\PycharmProjects\morse_code_project'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Aleksa Hadzic\PycharmProjects\morse_code_project\Scripts\deactivate.nu'
